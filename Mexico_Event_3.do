...
use "$mxfls3data/hh09dta_b3a/iiia_tb",clear

preserve
tempfile sex
use "$mxfls3data/hh09dta_bc/c_ls",clear
rename ls04 sex
rename ls02_2 age
...
// income info
merge 1:1 folio ls using "$mxfls3data/hh09dta_bc/c_portad"
rename _merge income_merge


// pregnancy history
merge 1:1 folio ls using "$mxfls3data/hh09dta_b4/iv_res"
rename _merge pregnancy_merge

// birth history
merge 1:1 folio ls using "$mxfls3data/hh09dta_b4/iv_he"
...
// education info
merge 1:1 folio ls using "$mxfls3data/hh09dta_b3a/iiia_ed"
rename _merge education_merge

// control info
preserve
tempfile control
use "$mxfls3data/hh09dta_b4/iv_conpor",clear
...
//drop folio ls
gen pid_link = substr(pid_link_3,1,6) + substr(pid_link_3,9,4)
drop pid_link_3
save "$data/Mexico_cleaned_3.dta",replace
